...
pub fn nav(props: &NavProps) -> Html {
    ...
    let nav_css = "display: flex; justify-content: center; align-items: center; gap: clamp(15px, 4vw, 40px); padding: 15px 30px; background: rgba(3,3,3,0.8); backdrop-filter: blur(20px); border-bottom: 1px solid rgba(255,255,255,0.05); position: fixed; width: 100%; top: 0; z-index: 1000;";
