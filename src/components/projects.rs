...
pub fn projects(props: &super::home::PageProps) -> Html {
    ...
    let exp_1 = use_state(|| false); let exp_2 = use_state(|| false); let exp_3 = use_state(|| false);
